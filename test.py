...
eval_dataset = build_dataset(cfg=data_cfg, transform=Resizer(img_sizes=data_cfg.get('img_sizes')))

eval_loader = torch.utils.data.DataLoader(eval_dataset, batch_size=data_cfg.get('batch_size'), collate_fn=collate_fn)
