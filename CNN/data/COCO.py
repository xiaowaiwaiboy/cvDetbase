...
if __name__ == "__main__":
    dataset = COCODataset("H:/DataSets/COCO/coco2017/train2017",
                          "H:/DataSets/COCO/coco2017/annotations/instances_train2017.json")
    ...
    for num, data in enumerate(train_loader):
        ...
        cv2.imwrite('img_{}.png'.format(num), image)
        cv2.waitKey(0)
