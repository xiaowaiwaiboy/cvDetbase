...
from cnn_model.data.utils import DATASETS, build_dataset
import cv2
import numpy as np
...
if __name__ == "__main__":
    ...
    train_dataset = VOCDataset(root_dir='H:/DataSets/VOCdevkit0712/VOCdevkit', train_set=train_set,
                                is_train=False, transform=transforms.Compose([Augmenter(),
                                                                              Resizer(img_sizes=None)]))
